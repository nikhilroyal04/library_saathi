...
import { createSubdomainAction } from '@/actions';
...
export function SubdomainForm() {
  ...
  // Handle client-side redirect when subdomain is created successfully
  useEffect(() => {
    ...
    if (state?.error && state.error.includes('must be logged in')) {
      window.location.href = '/login';
    }
  }, [state?.success, state?.redirectUrl, state?.error]);
